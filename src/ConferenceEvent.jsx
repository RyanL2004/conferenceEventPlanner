...
const ConferenceEvent = () => {
    ...
    const ItemsDisplay = ({ items }) => {
        ...
        <div className="display_box1">
            ...
            <table className="table_item-data">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th>Unit Cost</th>
                ...
                <tbody>
                    {items.map((item,index) => (
                        <tr key={index}>
                            ...
                            <td>
                                {item.type === "meals" || item.numberOPeople ? `${item.cost * numberOfPeople}` : `${item.cost * item.quantity}`}
                            </td>
                        </tr>
                    ))}
                </tbody>
        ...
        <div className="total_cost">Total Cost: ${venueTotalCost}</div>
                            ...
                            <div id="meals" className="venue_container container_main">
                                ...
                                <div className="meal_selection">
                                    ...
                                    <div className = "totalCost">Total Cost: {mealsTotalCost}</div>
                                </div>
